...
export class AppConstants {
  ...
  public static statsFilters: any = {
    done: {
  ...
  public static achievementsDefault: Achievement[] = [
    {
      description: "Vous vous êtes fixé 5 objectifs !",
      type: AchievementType.NbrObjectifs,
      number: 5,
      priority: 1
    },
    {
      description: "Vous vous êtes fixé 10 objectifs !",
      type: AchievementType.NbrObjectifs,
      number: 10,
      priority: 2
    },
    {
      description: "Vous vous êtes fixé 50 objectifs !",
      type: AchievementType.NbrObjectifs,
      number: 50,
      priority: 3
    },
    {
      description: "Vous vous êtes fixé 100 objectifs !",
      type: AchievementType.NbrObjectifs,
      number: 100,
      priority: 4
    },
    {
      description: "Vous vous êtes fixé 200 objectifs !",
      type: AchievementType.NbrObjectifs,
      number: 200,
      priority: 5
    },
    {
      description: "Vous vous êtes fixé 500 objectifs !",
      type: AchievementType.NbrObjectifs,
      number: 500,
      priority: 6
    },
    {
      description: "Vous avez atteint 5 objectifs !",
      type: AchievementType.NbrObjectifsDone,
      number: 5,
      priority: 1
    },
    {
      description: "Vous avez atteint 10 objectifs !",
      type: AchievementType.NbrObjectifsDone,
      number: 10,
      priority: 2
    },
    {
      description: "Vous avez atteint 50 objectifs !",
      type: AchievementType.NbrObjectifsDone,
      number: 50,
      priority: 3
    },
    {
      description: "Vous avez atteint 100 objectifs !",
      type: AchievementType.NbrObjectifsDone,
      number: 100,
      priority: 4
    },
    {
      description: "Vous avez atteint 200 objectifs !",
      type: AchievementType.NbrObjectifsDone,
      number: 200,
      priority: 5
    },
    {
      description: "Vous avez atteint 500 objectifs !",
      type: AchievementType.NbrObjectifsDone,
      number: 500,
      priority: 6
    }
