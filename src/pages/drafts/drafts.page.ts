...
import { NavController, ViewController, ActionSheetButton, AlertButton, Alert, AlertController, ActionSheet, ActionSheetController } from "ionic-angular";
...
export class DraftsPage implements OnInit {
    ...
    showActions(draft: any): void {
        ...
        const actionSheet: ActionSheet = this.actionSheetCtrl.create({
            title: draft.title != null && draft.title != '' ? draft.title : 'Brouillon sans titre',
            buttons: buttons
        });
